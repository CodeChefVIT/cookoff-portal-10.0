  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col lg:flex-row items-center justify-center text-white overflow-hidden pb-0 sm:pb-48 md:pb-0">
      ...
      <div className="flex flex-col min-h-screen bg-dark">
        ...
        <h2 className="text-center pt-8 pb-4 text-2xl md:text-3xl font-[Nulshock] tracking-widest text-white">
          CODECHEF-VIT PRESENTS
        </h2>

        {/* Main Content */}

        <div className="flex flex-col flex-1 lg:flex-row items-center justify-center w-full text-white">
          {/* Left Section */}
